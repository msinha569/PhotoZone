...
import { removeBg } from "../bgRemove/BgRemove"
...
const TransformationForm = ({action, data = null, userId, type, creditBalance}:TransformationFormProps) => {
    ...
    const [downloadUrlForBgRemove, setDownloadUrlForBgRemove] = useState<string | null>(null)
    ...
    async function onSubmit(values: z.infer<typeof formSchema>) {
      ...
      const onTransformHandler = async() => {
        ...
        if (transformationUrl2 && transformationType.type === 'removeBackground') {
          const localDownloadUrlForBgRemove = await removeBg(transformationUrl2);
          localDownloadUrlForBgRemove && setDownloadUrlForBgRemove(localDownloadUrlForBgRemove);
        }
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
           ...
           <div className="media-uploader-field">
                ...
                type={type}
                {...(downloadUrlForBgRemove && { downloadUrl: downloadUrlForBgRemove })}
